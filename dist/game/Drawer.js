...
import { BULLET_WIDTH, DEFAULT_SHIP_SIZE, LEFT_PADDING } from "./Game.js";
...
export class Drawer {
    ...
    changeDirectionIfNeeds() {
        if (this.currentLeftPosition + this.currentDirection * this.enemyMoveSpeed >= 0 &&
